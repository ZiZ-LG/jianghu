// ⚠️ 已退役（第5刀·坞收敛，2026-07）：无处渲染，待下次死代码清理时删除。职能去向——
//   姿态解读 → DeliberationDock 列① 现状锚；E2 背离提案 → 坞头警示行 .dock-shift；
//   预期回报/赢面老口径 → 删除（赢面唯一出口 = 坞头 PDE 内核徽章）；推演方案 playbook → 退役（裁决 C，由列② 顺推 + action-ranking 承接）。
// ── 原注释 ──
