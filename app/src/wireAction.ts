...
const nestedSpecs: Partial<Record<ActionType, NestedSpec>> = {
  ADD_ACCOUNT: { field: 'account', keys: ['id', 'name', 'customerType', 'unifiedCreditCode', 'externalRef', 'region', 'group', 'primaryOwner', 'profile'], shape: 'account' },
  UPDATE_ACCOUNT: { field: 'patch', keys: ['name', 'customerType', 'unifiedCreditCode', 'externalRef', 'region', 'group', 'primaryOwner', 'profile'], shape: 'account' },
  ADD_OPP: { field: 'opp', keys: ['id', 'name', 'customerType', 'pipelineStage', 'engageStage', 'changeMode', 'singleSalesGoal', 'customerBusinessGoal', 'buyingMotivation', 'c3Items', 'c5Items', 'externalRef', 'status', 'productSolution', 'competitor', 'competitiveSituation', 'winProbability', 'expectedSignDate', 'expectedAmountW', 'meta', 'memberScoped'] },
  UPDATE_OPP: { field: 'patch', keys: ['name', 'pipelineStage', 'engageStage', 'changeMode', 'singleSalesGoal', 'customerBusinessGoal', 'buyingMotivation', 'c3Items', 'c5Items', 'externalRef', 'status', 'productSolution', 'competitor', 'competitiveSituation', 'winProbability', 'expectedSignDate', 'expectedAmountW', 'meta'] },
  ADD_PERSON: { field: 'person', keys: ['id', 'name', 'title', 'orgLevel', 'isCompetitor', 'avatarUrl', 'coachLevel', 'x', 'y', 'form', 'logs'], shape: 'person' },
  UPDATE_PERSON: { field: 'patch', keys: ['name', 'title', 'orgLevel', 'avatarUrl', 'coachLevel', 'color', 'form', 'logs'], shape: 'person' },
  ...
  ADD_EDGE: { field: 'edge', keys: ['id', 'source', 'target', 'layer', 'label', 'color', 'style', 'width', 'directed', 'origin', 'shape', 'bend'] },
  UPDATE_EDGE: { field: 'patch', keys: ['source', 'target', 'layer', 'label', 'color', 'style', 'width', 'directed', 'shape', 'bend'] },
