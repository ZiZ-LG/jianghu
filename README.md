...
面向复杂大客户/大项目销售的「干系人作战地图」——可视化经营客户内部权力关系网（关系地图 L1–L4），用 **G64111 趋赢力**方法论打分，多人云端协作。

## 仓库结构

```
docs/        设计文档：产品设计方案.md（PRD）、G64111-评分规格.md（核心算分）
app/         前端：Vite + React + TypeScript（关系地图 + 趋赢力 + 全字段录入）
...
- ✅ **关系地图**：L1–L4 关系分层、5 角色、支持度、FORM 能源版、拖拽
