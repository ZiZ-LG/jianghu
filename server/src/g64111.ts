...
import { G64111_DEFINITION_MANIFEST, G64111_ENGINE_REF } from './methodology/g64111Manifest.js';

export * from '@jianghu/g64111';

export type {
  ScoringAccount as SAccount,
  ScoringBurningIssue as SBI,
  ScoringForm as SForm,
  ScoringOpportunity as SOpportunity,
  ScoringPerson as SPerson,
  ScoringRole as SRole,
  ScoringUcv as SUCV,
} from '@jianghu/g64111';
...
export const G64111_RUNTIME_CONFIG: G64111RuntimeConfig = Object.freeze({
  ...
  storageBindings: Object.freeze(G64111_DEFINITION_MANIFEST.fields.map((field) => Object.freeze({
    key: field.key,
