...
const FWD_TMPL: Record<string, string> = {
  ...
  C5: '补齐招采五事项（竞标方名单/家数、招标参数、评标规则、甲方项目代表、招标代理机构）',
  C3: '补齐立项七项材料并确认项目排序',
...
const PREFILL_TMPL: Record<string, Prefill> = {
  ...
  C5: { target: '补齐招采五事项：竞标方名单/家数、招标参数、评标规则、甲方项目代表、招标代理机构', resources: '采购线人脉、代理机构关系', cautions: '信息要交叉验证，单一来源不可靠', props: '招采信息核对清单' },
